...
export interface Config {
  ...
  leetcodeCsrf?: string;
  /**
   * Which curated subset the roadmap is drawn for: "blind75" | "neetcode150" |
   * "neetcode250" | "all". Default "neetcode250". Cyclable in-view; every box's
   * done/total count is scoped to it, so the whole chart redraws per subset.
   */
...
export const CONFIG_FIELDS: readonly ConfigField[] = [
  ...
  },
  {
    ...
    kind: "text",
    fallback: "neetcode250 (or: blind75, neetcode150, all)",
  },
  {
    key: "offline",
    label: "Offline mode",
...
/**
 * Curated subsets the roadmap can be drawn for, in cycle order (Tab advances
 * through them). Progression: blind75 ⊂ neetcode150 ⊂ neetcode250 ⊂ all.
 */
export const ROADMAP_SUBSETS = ["blind75", "neetcode150", "neetcode250", "all"] as const;
